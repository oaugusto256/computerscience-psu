...
def countWords(list1, list2):
    ...
    for word1 in list1:
        for word2 in list2:
            if word1 == word2:
                try:                       
                    dictionary[word2] += 1  # Try to append the number of occurrences of that word
                except:
                    dictionary[word2]  = 1  # If not work, create a dictionary with that word
...
def outputResults(dictionary, list2):
    ...
    print("\nThe amount occurs of words in file1 in file2 are:")                # Print the most common words
